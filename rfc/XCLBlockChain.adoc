...
This message:
 ...
 - is dumped as part of the snap shot at the end of each week and loaded at the start of the next week.ffa
...
If a trade does get executed, the result of placing a Limit Order is a:
